...
import com.example.textingapp.databinding.ItemContainerUserBinding;
...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.UserViewHolder>{
    ...
    {
        //byte[] bytes = android.util.Base64.decode(preferenceManager.getString(Konstante.KLJUC_SLIKA), android.util.Base64.DEFAULT);
