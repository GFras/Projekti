...
import com.example.textingapp.databinding.ItemContainerRecentConversionBinding;
...
public class RecentConversationsAdapter extends RecyclerView.Adapter<RecentConversationsAdapter.ConversionViewHolder> {
    ...
    public RecentConversationsAdapter(List<ChatMessage> chatMessages, ConversionListener conversionListener) { //Konstruktor
    ...
    class ConversionViewHolder extends RecyclerView.ViewHolder
    {
        ...
        ConversionViewHolder(ItemContainerRecentConversionBinding itemContainerRecentBinding)
        {
